 ...
 */
class SelectedItemsFragment(user: User) : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_selected_items, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            SelectedItemsFragment(PanelActivity.user).apply {
